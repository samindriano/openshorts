...
const HOOK_LOOKS: Record<string, HookLook> = {
  classic: { box: "rgba(248,250,252,0.96)", text: "#0F172A", outlinePx: 0, outlineColor: "#000", shadow: true, accentColor: "#D3A64C" },
  dark: { box: "rgba(18,18,20,0.92)", text: "#FFFFFF", outlinePx: 0, outlineColor: "#000", shadow: true, accentColor: null },
  yellow: { box: "rgba(255,214,0,0.96)", text: "#000000", outlinePx: 0, outlineColor: "#000", shadow: true, accentColor: null },
  red: { box: "rgba(220,38,38,0.96)", text: "#FFFFFF", outlinePx: 0, outlineColor: "#000", shadow: true, accentColor: null },
  outline: { box: null, text: "#FFFFFF", outlinePx: 8, outlineColor: "#000000", shadow: false, accentColor: null },
  outline_yellow: { box: null, text: "#FFD600", outlinePx: 8, outlineColor: "#000000", shadow: false, accentColor: null },
};
    ...
    >
      <div
        style={{
          ...
          position: "relative",
          borderRadius: 24,
          padding: look.box ? `${28 * scale}px ${36 * scale}px` : `${8 * scale}px ${12 * scale}px`,
